...
fruits1[0]= "Персик";
function test() {
  const fruits1 = ["Малина", "Клубника", "Банан"];
  let fruits2 = ["Груша", "Киви", "Хурма"];
  fruits2[0]= "Персик";
  console.log(fruits);
}
test();
...
// Киви Персик Банан Груша Хурма

// Варианты ответов
// ["Малина", "Клубника", "Банан"]
...
// Варианты ответов
// функция-конструктор (constructor function) // Правильный ответ
...
// Начало, Конец, Данные получены: [данные], SetTimeout 1, SetTimeout 2 // Правильный ответ
